...
`,
  ...
  return (
    <div className="teamPageContainer">
      <img
        className="homeImage"
        src="/assets/images/teamPageFeatureImg.png"
        alt="group photo"
      />
